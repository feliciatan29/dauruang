...
<div class="container py-5">
        <h2 class="text-center mb-5 fw-bold text-primary">Transaksi Berhasil</h2>
    ...
    <div class="container-xxl py-5">
        ...
        @forelse($riwayat as $item)
            @php
                $sampahData = json_decode($item->jenis_sampah, true);
            @endphp
            ...
            <div class="order-card mb-4">
                ...
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div class="d-flex align-items-center gap-2">
                        <span class="fw-semibold">Transaksi #{{ $item['id'] ?? 'N/A' }}</span>
                    </div>
                        ...
                        <p class="sampah-title">
                            ...
                            @if (is_array($sampahData))
                                @foreach ($sampahData as $sampah)
                                    <br>{{ $sampah['nama'] ?? '-' }} {{ $sampah['jumlah'] ?? '0' }}
                                @endforeach
                            @else
                                -
                            @endif
                ...
                <div class="action-footer mt-4">
                    <a class="btn btn-outline-success px-4 disabled">
