    ...
    <div class="container py-5">
            ...
            @forelse($pesananc as $item)
                <div class="order-card mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-3 text-center">
                            @if (!empty($item['gambar']))
                                <img src="{{ asset($item['gambar']) }}" alt="Gambar Pesanan"
                    ...
                    <div class="action-footer mt-4">
                        <p class="fw-semibold mb-2">Total: Rp {{ number_format($item['total_pesanan'] ?? 0, 0, ',', '.') }}
                        </p>
        ...
        <style>
            ...
            .step .icon {
                ...
                margin: 0 auto 4px;
                /* dari 10px jadi 4px agar jarak lebih dekat */
                font-size: 26px;
                color: #555;
            }
