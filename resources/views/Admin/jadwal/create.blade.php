...
<div class="col-lg-8 mb-4">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form class="user" method="POST" action="{{route('jadwal.store') }}" enctype="multipart/form-data">
                @csrf

                <div class="form-group">
                    <Label>No Jadwal :</Label>
                    <input type="text" class="form-control" name="no_jadwal">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="status_jemput">
                </div>
